...
4) [**키다리 은행 클라이언트 및 서버 개발**](development/2016/06/01/kidaribank/) (2016.05 ~ 2016.12)
...
5) [**Waterful (수분 섭취 보조 애플워치 응용 프로그램) - 수분 섭취 패턴 예측**](development/2015/09/01/waterful/) (2015.09 ~ 2015.11)
